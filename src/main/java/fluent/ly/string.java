...
public enum string {
	...
	@NotNull
	public static String capitalize(final @NotNull String ¢) {
		return ¢.length() == 0 ? ¢ : (first(¢) + "").toUpperCase() + the.rest(¢).toLowerCase();
	}

	@NotNull
	public static String cat(final @NotNull String... ss) {
	...
	@NotNull
	public static String cat(final @NotNull String[]... sss) {
		final @NotNull StringBuilder $ = new StringBuilder("");
	...
	@NotNull
	public static String esc(final @Nullable String s) {
		if (s == null)
			return "(null)";
	...
	@NotNull
	public static String expandLeadingTabs(final @NotNull String s) {
		nonnull(s);
		for (@NotNull
		String $ = s;;) {
	...
	@NotNull
	public static String fill(final int i, final @NotNull String s) {
		final @NotNull StringBuilder $ = new StringBuilder();
		for (int ¢ = 0; ¢ < i; ++¢)
			$.append(s);
		return $ + "";
	...
	@NotNull
	public static String javaCase(final @NotNull String ¢) {
	...
	@NotNull
	public static String pluralize(final int i, final @NotNull String singular) {
		return pluralize(i, singular, singular + "s");
	}

	@NotNull
	public static String pluralize(final int i, final @NotNull String singular, final @NotNull String plural) {
		switch (i) {
		case 0:
			return "no " + plural;
		case 1:
	...
	@NotNull
	public static String pretty(final @NotNull String singular, final Collection<?> a) {
		return pretty(singular, singular + "s", a);
	}

	@NotNull
	public static String pretty(final @NotNull String singular, final @NotNull String plural,
			final @Nullable Collection<?> a) {
		if (a == null || a.isEmpty())
			return "";
		if (a.size() == 1)
	...
	@NotNull
	public static String repeat(final int i, final @NotNull String s) {
	...
	@NotNull
	public static String sprintf(final @NotNull String format, final Object... args) {
	...
	@NotNull
	public static List<String> toLines(final @NotNull String s) throws IOException {
	...
	@NotNull
	public static String wrap(final char with, final @NotNull String s) {
		return with + s + with;
	}

	@NotNull
	public static String wrap(final @NotNull String with, final @NotNull String s) {
		return with + s + with;
	}
