...
public enum separate {
	...
	@NotNull
	public static String bySpaces(final @NotNull String... $) {
	...
	@NotNull
	public static String separateBySpaces(final @NotNull Iterator<String> s) {
	...
	@NotNull
	public static SeparationSubject these(final boolean @NotNull [] ¢) {
		return these(box.it(¢));
	}

	@NotNull
	public static SeparationSubject these(final byte @NotNull [] ¢) {
		return these(box.it(¢));
	}

	@NotNull
	public static SeparationSubject these(final char @NotNull [] ¢) {
		return these(box.it(¢));
	}

	@NotNull
	public static SeparationSubject these(final double @NotNull [] ¢) {
		return these(box.it(¢));
	}

	@NotNull
	public static SeparationSubject these(final float @NotNull [] ¢) {
		return these(box.it(¢));
	}
	...
	@NotNull
	public static SeparationSubject these(final long @NotNull [] ¢) {
		return these(box.it(¢));
	}

	@NotNull
	public static <Key, Value> SeparationSubject these(final @NotNull Map<Key, Value> ¢) {
		cantBeNull(¢);
	...
	@NotNull
	public static SeparationSubject these(final short @NotNull [] ¢) {
		return these(box.it(¢));
	}

	@SafeVarargs
	@NotNull
	public static <T> SeparationSubject these(final T... ¢) {
		return new SeparationSubject(¢);
	}
	...
	@NotNull
	public static SeparationSubject these(final int @NotNull [] ¢) {
		return these(box.it(¢));
	}
	...
	public static class SeparationSubject {
		 ...
		 */
		@NotNull
		static <T> String by(final @NotNull Iterable<? extends T> ts, final @NotNull String between) {
		 ...
		 */
		@NotNull
		static String separateBy(final @NotNull Iterable<?> os, final @NotNull String between) {
			final @NotNull Separator s = new Separator(between);
			final @NotNull StringBuffer $ = new StringBuffer();
			for (final Object ¢ : os)
				$.append(s).append(¢);
		...
		@NotNull
		static String separateBy(final @NotNull Object[] os, final @NotNull String between) {
			final @NotNull Separator s = new Separator(between);
			final @NotNull StringBuffer $ = new StringBuffer();
			for (final Object ¢ : os)
				$.append(s).append(¢);
		...
		@NotNull
		public String by(final @NotNull String between) {
