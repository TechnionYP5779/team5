...
public abstract class ___ {
	 ...
	 *                       <code>condition</code> was <code><b>false</b></code>
	 */
	public static void ensure(final boolean condition, final @NotNull String format, final Object... args)
	 ...
	 * @throws NonNegative in case <code>d</code> was negative
	 */
	public static void nonnegative(final double d, final @NotNull String format, final Object... args)
			throws NonNegative {
		if (d < 0)
	 ...
	 * @throws NonPositive in case <code>d</code> was positive
	 */
	public static void nonpositive(final double d, final @NotNull String format, final Object... args)
			throws NonPositive {
		if (d > 0)
	 ...
	 *                      <code>condition</code> was <code><b>false</b></code>
	 */
	public static void require(final boolean condition, final @NotNull String format, final Object... args)
			throws Precondition {
		if (!condition)
	 ...
	 *                   <code>condition</code> was <code><b>false</b></code>
	 */
	public static void sure(final boolean condition, final @NotNull String format, final Object... args)
			throws Invariant {
		if (!condition)
