...
public class azzert extends org.junit.Assert {
	...
	@SafeVarargs
	public static <T> Matcher<T> allOf(final Matcher<? super T>... ¢) {
		return AllOf.allOf(¢);
	}
	...
	@SafeVarargs
	public static <T> @Nullable AnyOf<T> anyOf(final Matcher<? super T>... ¢) {
		return AnyOf.anyOf(¢);
	}
	...
	public static <T> void assertCollectionsEqual(final @NotNull String s, final @NotNull Collection<T> c1,
			final @NotNull Collection<T> c2) {
		assertContained(s, c1, c2);
		assertContained(s, c2, c1);
	}

	public static <T> void assertCollectionsEqual(final @NotNull String s, final @NotNull Collection<T> ts1,
			final T[] ts2) {
		assertCollectionsEqual(s, ts1, Arrays.asList(ts2));
	}

	public static <T> void assertCollectionsEqual(final @NotNull String s, final T[] ts1,
			final @NotNull Collection<T> ts2) {
		assertCollectionsEqual(s, ts2, ts1);
	}

	public static <T> void assertContained(final @NotNull String s, final @NotNull Collection<T> c1,
			final @NotNull Collection<T> c2) {
	...
	public static void assertNotEquals(final @NotNull String message, final @NotNull String s1,
	...
	@NotNull
	public static Asserter aye(final @NotNull String reason, final boolean claim) {
	...
	@Factory
	public static Matcher<@Nullable Boolean> comparesEqualTo(final boolean ¢) {
		return OrderingComparison.comparesEqualTo(box.it(¢));
	}

	@Factory
	public static Matcher<@Nullable Byte> comparesEqualTo(final byte ¢) {
		return OrderingComparison.comparesEqualTo(box.it(¢));
	}

	@Factory
	public static Matcher<@Nullable Character> comparesEqualTo(final char ¢) {
		return OrderingComparison.comparesEqualTo(box.it(¢));
	}

	@Factory
	public static Matcher<@Nullable Double> comparesEqualTo(final double ¢) {
		return OrderingComparison.comparesEqualTo(box.it(¢));
	}

	@Factory
	public static Matcher<@Nullable Float> comparesEqualTo(final float ¢) {
		return OrderingComparison.comparesEqualTo(box.it(¢));
	}

	@Factory
	public static Matcher<@Nullable Integer> comparesEqualTo(final int ¢) {
		return OrderingComparison.comparesEqualTo(box.it(¢));
	}

	@Factory
	public static Matcher<@Nullable Long> comparesEqualTo(final long ¢) {
		return OrderingComparison.comparesEqualTo(box.it(¢));
	}

	@Factory
	public static Matcher<@Nullable Short> comparesEqualTo(final short ¢) {
		return OrderingComparison.comparesEqualTo(box.it(¢));
	}
	...
	public static <T> Matcher<T> describedAs(final @NotNull String description, final Matcher<T> m,
			final Object... values) {
	...
	public static <T> void equals(final @NotNull String prefix, final @NotNull Collection<T> set,
			final @NotNull Collection<T> ts) {
		@NotNull
	...
	@Factory
	public static Matcher<@Nullable Boolean> greaterThan(final boolean ¢) {
		return OrderingComparison.greaterThan(box.it(¢));
	}

	@Factory
	public static Matcher<@Nullable Byte> greaterThan(final byte ¢) {
		return OrderingComparison.greaterThan(box.it(¢));
	}

	@Factory
	public static Matcher<@Nullable Character> greaterThan(final char ¢) {
		return OrderingComparison.greaterThan(box.it(¢));
	}

	@Factory
	public static Matcher<@Nullable Double> greaterThan(final double ¢) {
		return OrderingComparison.greaterThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Float> greaterThan(final float ¢) {
		return OrderingComparison.greaterThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Integer> greaterThan(final int ¢) {
		return OrderingComparison.greaterThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Long> greaterThan(final long ¢) {
		return OrderingComparison.greaterThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Short> greaterThan(final short ¢) {
		return OrderingComparison.greaterThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Boolean> greaterThanOrEqualTo(final boolean ¢) {
		return OrderingComparison.greaterThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Byte> greaterThanOrEqualTo(final byte ¢) {
		return OrderingComparison.greaterThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Character> greaterThanOrEqualTo(final char ¢) {
		return OrderingComparison.greaterThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Double> greaterThanOrEqualTo(final double ¢) {
		return OrderingComparison.greaterThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Float> greaterThanOrEqualTo(final float ¢) {
		return OrderingComparison.greaterThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Integer> greaterThanOrEqualTo(final int ¢) {
		return OrderingComparison.greaterThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Long> greaterThanOrEqualTo(final long ¢) {
		return OrderingComparison.greaterThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Short> greaterThanOrEqualTo(final short ¢) {
		return OrderingComparison.greaterThanOrEqualTo(box.it(¢));
	}

	@NotNull
	public static <T> Matcher<java.lang.Iterable<? super @Nullable T>> hasItem(
			final Matcher<? super @Nullable T> itemMatcher) {
	...
	@Contract(pure = true)
	public static <@Nullable T> @NotNull Matcher<T> is(final @Nullable T value) {
		return Is.is(value);
	}
	...
	public static void isNull(final @NotNull String message, final @Nullable Object o) {
		azzert.assertNull(message, o);
	}

	@NotNull
	public static Outer<String> iz(final @NotNull String ¢) {
		return new Outer<>(¢);
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Boolean> lessThan(final boolean ¢) {
		return OrderingComparison.lessThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Byte> lessThan(final byte ¢) {
		return OrderingComparison.lessThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Character> lessThan(final char ¢) {
		return OrderingComparison.lessThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Double> lessThan(final double ¢) {
		return OrderingComparison.lessThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Float> lessThan(final float ¢) {
		return OrderingComparison.lessThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Integer> lessThan(final int ¢) {
		return OrderingComparison.lessThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Long> lessThan(final long ¢) {
		return OrderingComparison.lessThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Short> lessThan(final short ¢) {
		return OrderingComparison.lessThan(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Boolean> lessThanOrEqualTo(final boolean ¢) {
		return OrderingComparison.lessThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Byte> lessThanOrEqualTo(final byte ¢) {
		return OrderingComparison.lessThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Character> lessThanOrEqualTo(final char ¢) {
		return OrderingComparison.lessThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Double> lessThanOrEqualTo(final double ¢) {
		return OrderingComparison.lessThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Float> lessThanOrEqualTo(final float ¢) {
		return OrderingComparison.lessThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Integer> lessThanOrEqualTo(final int ¢) {
		return OrderingComparison.lessThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Long> lessThanOrEqualTo(final long ¢) {
		return OrderingComparison.lessThanOrEqualTo(box.it(¢));
	}

	@Factory
	@NotNull
	public static Matcher<@Nullable Short> lessThanOrEqualTo(final short ¢) {
		return OrderingComparison.lessThanOrEqualTo(box.it(¢));
	}
	...
	@NotNull
	public static Asserter nay(final @NotNull String reason, final boolean claim) {
	...
	@NotNull
	public static Matcher<String> startsWith(final @NotNull String prefix) {
	...
	public static void that(final @NotNull String reason, final byte b,
			final @NotNull Matcher<? super @Nullable Byte> m) {
		assertThat(reason, box.it(b), m);
	}
	...
	public static void that(final @NotNull String reason, final double d,
			final @NotNull Matcher<? super @Nullable Double> m) {
	...
	public static void that(final @NotNull String reason, final long l,
			final @NotNull Matcher<? super @Nullable Long> m) {
	...
	public static <@Nullable T> void that(final @NotNull String reason, final @Nullable T actual,
			final @NotNull Matcher<? super @Nullable T> t) {
	...
	public static class Asserter {
		...
		@NotNull
		public Asserter andAye(final @NotNull String reason, final boolean claim) {
		...
		@NotNull
		public Asserter andNay(final @NotNull String reason, final boolean claim) {
