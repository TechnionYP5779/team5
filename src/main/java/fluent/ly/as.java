...
public enum as {
	 ...
	 */
	@SafeVarargs
	public static <T> Iterator<T> iterator(final T... ¢) {
	 ...
	 */
	@SafeVarargs
	public static <T> @NotNull List<T> list(final T... $) {
	 ...
	 */
	@SafeVarargs
	public static <T> Set<? extends T> set(final @Nullable T... ¢) {
		return accumulate.to(new HashSet<T>()).add(¢).elements();
	}

	@NotNull
	public static String string(final @Nullable Object $) {
		return $ == null ? "null" : as.string($ + "");
	}

	@NotNull
	public static String string(final char $) {
		return $ + "";
	}

	@NotNull
	public static String string(final @Nullable String $) {
		return $ != null ? $ : "null";
	}
