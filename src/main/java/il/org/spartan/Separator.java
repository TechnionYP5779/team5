...
public final class Separator {
	 ...
	 */
	public static <T> String wrap(final @NotNull String begin, final @NotNull String end, final Iterable<T> ts,
			final @NotNull String between) {
		if (is.empty(ts))
			return "";
	 ...
	 * @param between what to put between the items
	 */
	public static <T> String wrap(final @NotNull String begin, final @NotNull String end, final @NotNull T[] ts,
			final @NotNull String between) {
		if (ts.length == 0)
			return "";
		final @NotNull StringBuilder $ = new StringBuilder(begin);
