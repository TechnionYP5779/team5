...
public class CSVStatistics extends CSVLine.Ordered {
	...
	@Override
	public CSVStatistics put(final @NotNull String key, final double value, final FormatSpecifier... ss) {
	...
	@Override
	public CSVStatistics put(final @NotNull String key, final int value) {
		getStatistics(key).record(value);
		super.put(key, value);
		return this;
	}
	...
	@Override
	public CSVStatistics put(final @NotNull String key, final long value) {
		getStatistics(key).record(value);
		super.put(key, value);
		return this;
	}
