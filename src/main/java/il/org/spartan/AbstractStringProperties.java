...
public abstract class AbstractStringProperties {
	...
	@Override
	@Nullable
	public AbstractStringProperties clone() {
		try {
	...
	public static class ListProperties extends AbstractStringProperties {
		...
		@Override
		@NotNull
		public ListProperties put(final @NotNull String key, final @NotNull String value) {
			keys.add(key);
			values.add(value);
			return this;
		}
	...
	public enum Renderer {
		CSV {
			...
			@Override
			@NotNull
			public String makeField(final @Nullable String ¢) {
				return ¢ == null ? ""
						: !¢.contains(QUOTE) && !¢.contains(delimiter()) ? ¢
								: QUOTE + ¢.replaceAll(QUOTE, QUOTE + QUOTE) + QUOTE;
			}
		...
		MATRIX {
			...
			@Override
			String makeField(final @NotNull String ¢) {
		...
		LaTeX() {
			...
			@Override
			@NotNull
			String makeField(final @Nullable String ¢) {
