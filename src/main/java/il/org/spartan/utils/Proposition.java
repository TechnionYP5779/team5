...
public interface Proposition extends BooleanSupplier {
	...
	static Proposition AND(final @Nullable String toString, final BooleanSupplier s1, final BooleanSupplier s2,
	...
	static Proposition OR(final @NotNull String toString, final BooleanSupplier s1, final BooleanSupplier s2,
			final BooleanSupplier... ss) {
	...
	final class And extends Some {
		...
		And(final @NotNull String toString, final BooleanSupplier s1, final BooleanSupplier s2,
				final BooleanSupplier[] ss) {
			super(toString);
			add(s1, s2, ss);
		}
		...
		@Override
		public Proposition and(final BooleanSupplier s, final BooleanSupplier... ss) {
		...
		@Override
		public Proposition or(final BooleanSupplier s, final BooleanSupplier... ss) {
	...
	final class Or extends Some {
		...
		public Or(final @NotNull String toString, final BooleanSupplier s1, final BooleanSupplier s2,
				final BooleanSupplier[] ss) {
			super(toString);
			add(s1, s2, ss);
		}
		...
		@Override
		public Proposition and(final BooleanSupplier s, final BooleanSupplier... cs) {
		...
		@Override
		public Proposition or(final BooleanSupplier s, final BooleanSupplier... cs) {
	...
	class Singleton extends Aggregate<BooleanSupplier> implements Recursive.Atomic<Proposition> {
		...
		@Override
		public final Proposition and(final BooleanSupplier s, final BooleanSupplier... cs) {
			return new And(this, s, cs);
		}
