...
//  };
  ...
  @Test public void test_all() {
    forget.all(new Pair<Integer,Integer>(1,2), new Pair<Integer,Integer>(1,2),new Pair<Integer,Integer>(1,2),new Pair<Integer,Integer>(1,2));// should print "who?"
    forget.all(new Pair<Integer,Integer>(1,2));// should print "who?"
    forget.all(new String(), new Pair<Integer,Integer>(1,2),new Pair<Integer,Integer>(1,2),new Pair<Integer,Integer>(1,2));// should print "who are those 3 people?"
    forget.all(new String());// should print "who are those 0 people?"
    forget.all(new String(), new Pair<Integer,Integer>(1,2),new Pair<Integer,Integer>(1,2),"varargs");// should print "who are those 2 people?"
  }
  ...
  @Test public void test_it() {
    ...
    forget.it((Object)new Pair<Integer,Integer>(1,2));// should print "o is just fine"
