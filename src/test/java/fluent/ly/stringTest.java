...
//    assertEquals("he  l   lo  ",string.expandLeadingTabs("he\tl\t\tlo\t"));
  ...
  @Test public void test_paren(){
    ...
    assertEquals("(<1,2>)",string.paren(new Pair<Integer,Integer>(1,2)));
  }
  ...
  @Test public void test_pretty(){
    ...
    assertEquals("1 course: 234311\n",string.pretty("course","courses",new ArrayList<Integer>(Arrays.asList(234311))));
  ...
  @Test public void test_sprintf(){
    String[] a= {},b= {"hell"},c= {"what %s %s","the","hell"};
  ...
  @Test public void test_toLines(){
    try {
      List<String> l1 = string.toLines("hello world\n\twhat\nis up\ndone\n\n");
