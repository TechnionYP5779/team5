...
public class stringTest {
  ...
  @Test public void test_cat() {
    ...
    azzert.that(s1,azzert.is("Hello World"));
  ...
  @Test @SuppressWarnings("deprecated") public void test_delta() {
    ...
    azzert.that(true, azzert.is(0 == string.delta(d1, d3)));
  ...
  @Test public void test_esc() {
    ...
    azzert.that(string.esc('\\'),azzert.is("\\\\"));
    azzert.that(string.esc('\''),azzert.is("\'")); // also an escaper, but not in the cases
    azzert.that(string.esc('\"'),azzert.is("\"")); // also an escaper, but not in the cases
  ...
  @Test public void test_expandLeadingTabs() {
    ...
    // azzert.that(" he l lo",string.expandLeadingTabs("\the\tl\t\tlo"));
    // azzert.that("he l lo ",string.expandLeadingTabs("he\tl\t\tlo\t"));
  }
  ...
  @Test public void test_pretty() {
    azzert.that(string.pretty("hope", null),azzert.is(""));
  ...
  @Test public void test_toLines() {
    try {
      ...
      azzert.that(l1.get(4),azzert.is("")); // or null
  ...
  @Test public void test_visualize() {
    ...
    azzert.that(string.visualize("\\"),azzert.is("\\\\"));
    azzert.that(string.visualize("\'"),azzert.is("\'")); // also an escaper, but not in the cases
    azzert.that(string.visualize("\""),azzert.is("\"")); // also an escaper, but not in the cases
