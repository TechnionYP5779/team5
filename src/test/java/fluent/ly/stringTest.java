...
public class stringTest {
	...
	@Test
	public void test_atod() {
		@NotNull
		final Double $ = box.it(string.atod("42.001"));
		@NotNull
		final String s = new String("333");
		@NotNull
		final Double $2 = box.it(string.atod(s));
	...
	public void test_capitalize() {
		final String s2 = string.capitalize("Hello"), s3 = string.capitalize("hello"), s4 = string.capitalize("hELLo"),
	...
	@Test
	public void test_expandLeadingTabs() {
	...
	@Test
	public void test_javaCase() {
		final String s2 = string.javaCase("Hello"), s3 = string.javaCase("hello"), s4 = string.javaCase("hELLo"),
	...
	public void test_pretty() {
		...
		azzert.that(string.pretty("course", "courses", new ArrayList<>(Arrays.asList(box.it(234311)))),
				is("1 course: 234311\n"));
