...
public class stringTest {
  ...
  @Test @SuppressWarnings({ "static-method", "null" }) public void test_atod() {
    ...
    azzert.that(true, is($ > 42.00));
    azzert.that(true, is(Double.MAX_VALUE == $2));
    azzert.that(false, is($ == 42));
  }
  ...
  @Test @SuppressWarnings({ "static-method", "null" }) public void test_atof() {
    ...
    azzert.that(true, is(Float.MAX_VALUE == $2));
    azzert.that(false, is(Integer.MAX_VALUE == $2));
  }
  ...
  @Test @SuppressWarnings({ "static-method", "null" }) public void test_atoi() {
    ...
    azzert.that(true, is(Integer.MAX_VALUE == $2));
    azzert.that(false, is(Float.MAX_VALUE == $2));
  }
  ...
  @Test @SuppressWarnings({ "static-method", "null" }) public void test_atol() {
    ...
    azzert.that(true, is(Long.MAX_VALUE == $2));
    azzert.that(false, is(Integer.MAX_VALUE == $));
  }
  ...
  @Test @SuppressWarnings({ "static-method", "boxing" }) public void test_eq() {
    azzert.that(true, is(string.eq(4, 4)));
    azzert.that(false, is(string.eq(3, 4)));
    azzert.that(true, is(string.eq(null, null)));
    azzert.that(false, is(string.eq(4, null)));
    azzert.that(false, is(string.eq(null, 4)));
    azzert.that(true, is(string.eq(new Pair<>(1, 2), new Pair<>(1, 2))));
  }
  ...
  @Test @SuppressWarnings({ "static-method", "boxing" }) public void test_paren() {
    azzert.that(string.paren(4), is("(4)"));
    azzert.that(string.paren("$"), is("($)"));
    azzert.that(string.paren(new Pair<>(1, 2)), is("(<1,2>)"));
  }
  ...
  @Test @SuppressWarnings({ "boxing", "static-method" }) public void test_pretty() {
    ...
    azzert.that(string.pretty("course", "courses", new ArrayList<>(Arrays.asList(234311))), is("1 course: 234311\n"));
  ...
  @Test @SuppressWarnings({ "static-method", "boxing" }) public void test_quote() {
    ...
    azzert.that(string.quote("\tlet it be epsilon>0\t"), is("'\tlet it be epsilon>0\t'"));
    azzert.that(string.quote(42), is("'42'"));
  }
  ...
  @Test @SuppressWarnings({ "static-method", "null" }) public void test_visualize() {
    ...
    azzert.that(string.visualize(null), is("(null)"));
