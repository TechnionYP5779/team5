...
public class unboxTest {
  @SuppressWarnings({ "static-method", "null" }) @Test public void testUnboxBooleanArray() {
  ...
  @SuppressWarnings({ "static-method", "null" }) @Test public void testUnboxByteArray() {
    final byte[] expected = { 0, 1, 2, 3 };
    final Byte[] tested = { Byte.valueOf("0"), Byte.valueOf("1"), Byte.valueOf("2"), Byte.valueOf("3") };
    azzert.that(unbox.unbox(tested), azzert.is(expected));
  }

  @SuppressWarnings({ "static-method", "null" }) @Test public void testUnboxCharacterArray() {
  ...
  @SuppressWarnings({ "static-method", "null" }) @Test public void testUnboxShortArray() {
  ...
  @SuppressWarnings({ "static-method", "null" }) @Test public void testUnboxDoubleArray() {
  ...
  @SuppressWarnings("static-method") @Test public void testUnboxFloatArray() {
  ...
  @SuppressWarnings({ "static-method", "null" }) @Test public void testUnboxIntegerArray() {
    final int[] expected = { 1, 2, 3, 4 };
    final Integer[] tested = { Integer.valueOf(1), Integer.valueOf(2), Integer.valueOf(3), Integer.valueOf(4) };
    azzert.that(unbox.unbox(tested), azzert.is(expected));
  }

  @SuppressWarnings({ "static-method", "null" }) @Test public void testUnboxLongArray() {
