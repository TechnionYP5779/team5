...
@SuppressWarnings({ "static-method", "static-access" }) public class unboxTest {
  ...
  @Test public void testUnboxByteArray() {
    azzert.that(unbox.unbox(new Byte[] { box.box((byte) 0), box.box((byte) 1), box.box((byte) 2), box.box((byte) 3) }),
        is(new byte[] { 0, 1, 2, 3 }));
  }
  ...
  @Test public void testUnboxShortArray() {
    azzert.that(unbox.unbox(new Short[] { box.box((short) 1), box.box((short) 2), box.box((short) 3), box.box((short) 4) }),
