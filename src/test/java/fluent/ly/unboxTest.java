...
public class unboxTest {
  @Test @SuppressWarnings({ "static-method", "null" }) public void testUnboxBooleanArray() {
  ...
  @Test @SuppressWarnings({ "static-method", "null" }) public void testUnboxByteArray() {
    azzert.that(unbox.unbox(new Byte[] { Byte.valueOf("0"), Byte.valueOf("1"), Byte.valueOf("2"), Byte.valueOf("3") }), azzert.is(new byte[] { 0, 1, 2, 3 }));
  }

  @Test @SuppressWarnings({ "static-method", "null" }) public void testUnboxCharacterArray() {
  ...
  @Test @SuppressWarnings({ "static-method", "null" }) public void testUnboxIntegerArray() {
    azzert.that(unbox.unbox(new Integer[] { Integer.valueOf(1), Integer.valueOf(2), Integer.valueOf(3), Integer.valueOf(4) }), azzert.is(new int[] { 1, 2, 3, 4 }));
  }

  @Test @SuppressWarnings({ "static-method", "null" }) public void testUnboxLongArray() {
