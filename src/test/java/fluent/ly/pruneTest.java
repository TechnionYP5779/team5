...
public class pruneTest {
	...
	@NotNull
	private final List<String> sparseCollection = as.list(null, null, null, null, null, "A", null, null, null, "B",
	...
	@Test
	public void nullsNullArrayItems() {
	...
	@Test
	public void nullsPruneArrayAltenatingItems() {
	...
	@Test
	public void nullsPruneArrayAltenatingLength() {
		azzert.that(3, is(prune.nulls(alternatingArray).length));
	}

	@Test
	public void nullsPruneSparseCollectionContents() {
	...
	@Test
	public void nullsPruneSparseCollectionLength() {
		azzert.that(3, is(prune.nulls(sparseCollection).size()));
	}

	@Test
	public void nullsPrunNotNull() {
	...
	@Test
	public void shrinkEmptyArray() {
		azzert.that(0, is(prune.shrink(new Object[0]).length));
	}

	@Test
	public void whitesEmptyArray() {
		azzert.that(0, is(prune.whites().length));
	}

	@Test
	public void whitesEmptyList() {
		azzert.that(0, is(prune.whites().length));
	}

	@NotNull
	final Supplier<List<String>> x = () -> {
	...
	@NotNull
	private final List<String> sparseCollection1 = new Supplier<List<String>>() {
		@Override
		@NotNull
	...
	@Test
	public void testNotNullArrayItems() {
	...
	@Test
	public void testNotNullArrayLength() {
		azzert.that(prune.nulls(nonNullArray).length, is(nonNullArray.length));
	}

	@Test
	public void testPruneArrayAltenatingItems() {
	...
	@Test
	public void testPruneArrayAltenatingLength() {
		azzert.that(prune.nulls(alternatingArray).length, is(3));
	}

	@Test
	public void testPruneSparseCollectionContents() {
	...
	@Test
	public void testPruneSparseCollectionLength() {
		azzert.that(prune.nulls(sparseCollection1).size(), is(3));
	}

	@Test
	public void testPrunNotNull() {
