...
public class iterablesTest {
	...
	@Test
	public void containseturnsFalseTypical() {
	...
	@Test
	public void containsTypical() {
		azzert.aye("", contains("Hello", "a", "b", "c", "d", "e", "f"));
	}

	@Test
	public void containsWithNulls() {
		azzert.aye("", contains("Hello", null, "a", "b", null, "c", "d", "e", "f", null));
	}

	@Test
	public void countDoesNotIncludeNull() {
	...
	@Test
	public void alternateFirstIterableNullTest() {
		final Iterable<Integer> it1 = new ArrayList<>();
	...
	@Test
	public void alternateGenericAlternate() {
