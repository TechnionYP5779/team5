...
public class RealStatisticsTest {
	...
	@Test
	public void medianMiddle() {
		azzert.that(0.5, is(s_4x0_5x1.record(0).median()));
	}

	@Test
	public void medianMovingDown() {
		azzert.that(0, is(s_4x0_5x1.record(0).record(0).median()));
	}

	@Test
	public void mediannMovingDown() {
		azzert.that(0, is(s_4x0_5x1.record(0).record(0).median()));
	}

	@Test
	public void medianNotMovingUp() {
		azzert.that(1, is(s_4x0_5x1.record(5).record(6).median()));
	}
	...
	@Test
	public void testMedianNotMovingUp() {
		azzert.that(1, is(s_4x0_5x1.record(5).record(6).median()));
	}
