...
@SuppressWarnings("static-method") public class RealStatisticsTest {
  ...
  @Test public void all() {
    ...
    azzert.that(11, azzert.is(vs[0]));
    azzert.that(20, azzert.is(vs[1]));
    azzert.that(5, azzert.is(vs[2]));
  }
  ...
  @Test public void max() {
    azzert.that(20, azzert.is(s11_20_5.max()));
    azzert.that(5, azzert.is(s15.max()));
    azzert.that(7, azzert.is(s07.max()));
    azzert.that(1, azzert.is(s_4x0_5x1.max()));
  }

  @Test public void mean() {
    azzert.that(12, azzert.is(s11_20_5.mean()));
    azzert.that(3, azzert.is(s15.mean()));
    azzert.that(3.5, azzert.is(s07.mean()));
    azzert.that(5 / 9.0, azzert.is(s_4x0_5x1.mean()));
  }

  @Test(expected = ArithmeticException.class) public void meanEmpty() {
    final @NotNull RealStatistics x = new RealStatistics();
    azzert.that(0, azzert.is(x.mean()));
    x.relativeError();
  }
  ...
  @Test public void median() {
    azzert.that(11, azzert.is(s11_20_5.median()));
    azzert.that(3, azzert.is(s15.median()));
    azzert.that(3.5, azzert.is(s07.median()));
    azzert.that(1, azzert.is(s_4x0_5x1.median()));
    azzert.that(1, azzert.is(s_4x0_5x1.record(1).median()));
    azzert.that(1, azzert.is(s_4x0_5x1.record(5).median()));
    azzert.that(1, azzert.is(s_4x0_5x1.record(5).record(6).median()));
    azzert.that(1, azzert.is(s_4x0_5x1.record(0).median()));
    azzert.that(1, azzert.is(s_4x0_5x1.record(0).median()));
    azzert.that(1, azzert.is(s_4x0_5x1.record(0).median()));
    azzert.that(1, azzert.is(s_4x0_5x1.record(0).median()));
    azzert.that(0.5, azzert.is(s_4x0_5x1.record(0).median()));
    azzert.that(0, azzert.is(s_4x0_5x1.record(0).median()));
  }
  ...
  @Test public void medianMovingDown() {
    azzert.that(0, azzert.is(s_4x0_5x1.record(0).record(0).median()));
  }
  ...
  @Test public void min() {
    azzert.that(5, azzert.is(s11_20_5.min()));
    azzert.that(1, azzert.is(s15.min()));
    azzert.that(0, azzert.is(s07.min()));
    azzert.that(0, azzert.is(s_4x0_5x1.min()));
  }
  ...
  @Test public void sum() {
    azzert.that(36, azzert.is(s11_20_5.sum()));
    azzert.that(15, azzert.is(s15.sum()));
    azzert.that(28, azzert.is(s07.sum()));
    azzert.that(5.0, azzert.is(s_4x0_5x1.sum()));
  }

  @Test public void testMax() {
    azzert.that(20, azzert.is(s.max()));
    azzert.that(5, azzert.is(s15.max()));
    azzert.that(7, azzert.is(s07.max()));
    azzert.that(1, azzert.is(s_4x0_5x1.max()));
  }
  ...
  @Test public void testMean() {
    azzert.that(12, azzert.is(s.mean()));
    azzert.that(3, azzert.is(s15.mean()));
    azzert.that(3.5, azzert.is(s07.mean()));
    azzert.that(5 / 9.0, azzert.is(s_4x0_5x1.mean()));
  }
  ...
  @Test public void testMedian() {
    azzert.that(11, azzert.is(s.median()));
    azzert.that(3, azzert.is(s15.median()));
    azzert.that(3.5, azzert.is(s07.median()));
    azzert.that(1, azzert.is(s_4x0_5x1.median()));
    azzert.that(1, azzert.is(s_4x0_5x1.record(1).median()));
  ...
  @Test public void testSum() {
    azzert.that(36, azzert.is(s.sum()));
    azzert.that(15, azzert.is(s15.sum()));
    azzert.that(28, azzert.is(s07.sum()));
    azzert.that(5.0, azzert.is(s_4x0_5x1.sum()));
  }
