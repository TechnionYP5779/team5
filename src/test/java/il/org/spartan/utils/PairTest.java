...
public class PairTest {
  ...
  @Test @SuppressWarnings({ "static-method", "boxing" }) public void test_makePairs() {
  ...
  @Test @SuppressWarnings({ "boxing", "static-method" }) public void test_equals() {
  ...
  @Test @SuppressWarnings({ "static-method", "boxing" }) public void test_hash() {
    azzert.that(new Pair<>(1, 2).hashCode(), azzert.is(2));
  }

  @Test @SuppressWarnings({ "static-method", "boxing" }) public void test_toString() {
    final Pair<Integer, Integer> p2 = Pair.newPair(3, 4), p3 = Pair.newPair(1, 2);
    azzert.that(new Pair<>(1, 2) + "", azzert.is("<1,2>"));
