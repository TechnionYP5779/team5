...
public class LinearRegressionTest {
	...
	@Test
	public void predictLinearDown2() {
		final PairsList p = new PairsList();
		for (int ¢ = 0; ¢ < 5; ¢++)
			p.record(¢ + 1, ¢ - 4);
		final LinearRegression l = new LinearRegression(p);
	...
	@Test
	public void predictAlmostConst() {
		final PairsList p = new PairsList();
		for (int ¢ = 0; ¢ < 3000; ¢++)
	...
	@Test
	public void predictAlmostConst2() {
		final PairsList p = new PairsList();
		for (int ¢ = 0; ¢ < 3000; ¢++)
			p.record(¢ + 1, ¢ % 2 == 0 ? 4.0 : 6.0);
		final LinearRegression l = new LinearRegression(p);
