...
public class TabTest {
	...
	@Test
	public void emtpyTrue() {
		assert new Tab().isEmpty();
	}

	@Test
	public void testBeginAtLevelOne() {
		final @NotNull Tab t = new Tab("abc");
		t.more();
	...
	@Test
	public void testOneMoreOneLess() {
		final @NotNull Tab t = new Tab("abc");
		t.more();
		t.less();
		azzert.that(t + "", is(""));
	...
	@Test
	public void testTwoMoreOneLess() {
		final @NotNull Tab t = new Tab("abc");
		t.more();
		t.more();
		t.less();
	...
	@Test
	public void testTwoMoreTwoLessOneMore() {
		final @NotNull Tab t = new Tab("abc");
		t.more();
		t.more();
		t.less();
	...
	@Test
	public void testTwoMoreTwoLessTwoMore() {
		final @NotNull Tab t = new Tab("abc");
		t.more();
		t.more();
		t.less();
