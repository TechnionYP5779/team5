...
//    azzert.that(TableRenderer.builtin.MARKDOWN.arraySeparator(), azzert.is("; "));
    ...
    azzert.that(TableRenderer.builtin.MARKDOWN.cellReal(new Double(4.3)), azzert.is("4"));
    azzert.that(TableRenderer.builtin.MARKDOWN.cellReal(new Double(Double.NaN)), azzert.is("NaN"));
