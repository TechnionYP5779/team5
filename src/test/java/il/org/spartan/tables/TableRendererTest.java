...
//    azzert.that(TableRenderer.builtin.MARKDOWN.cellReal(4.3), azzert.is("4"));
//    azzert.that(TableRenderer.builtin.MARKDOWN.cellReal(Double.NaN), azzert.is("NaN"));
...
//    azzert.that(TableRenderer.builtin.CSV.cellInt((long) 4), azzert.is("4"));
