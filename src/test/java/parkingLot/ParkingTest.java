...
@SuppressWarnings("static-method") public class ParkingTest {
  ...
  @Test public void availableSlotTest() {
    ...
    azzert.that(p.getAvailableSlots().size(), is(1));
    azzert.that(p.getAvailableSlots().get(0), is(new Slot(new GregorianCalendar(2018, 11, 27, 8, 00),
        new GregorianCalendar(2018, 11, 27, 9, 00), 5.5)));
    azzert.that(p.getAvailableSlots().get(0).getPrice_for_hour(), is(5.5));
    p.removeAvailableSlot(new GregorianCalendar(2018, 11, 27, 8, 00),
        new GregorianCalendar(2018, 11, 28, 9, 00));
    azzert.that(p.getAvailableSlots().size(), is(1));
    p.removeAvailableSlot(new GregorianCalendar(2018, 11, 27, 8, 00), new GregorianCalendar(2018, 11, 27, 9, 00));
    azzert.that(p.getAvailableSlots().size(), is(0));
    p.addAvailableSlot(new Slot(new GregorianCalendar(2018, 11, 27, 8, 00), 
        new GregorianCalendar(2018, 11, 27, 9, 00), 5.5));
    azzert.that(p.getAvailableSlots().size(), is(1));
    p.addAvailableSlot(new GregorianCalendar(2018, 11, 27, 8, 30), new GregorianCalendar(2018, 11, 27, 9, 30), 5.5);
    azzert.that(p.getAvailableSlots().size(), is(1));
    ...
    p.addAvailableSlot(new Slot(new GregorianCalendar(2018, 11, 27, 8, 00),
        new GregorianCalendar(2018, 11, 27, 9, 00), 5.5));
    azzert.that(p.getAvailableSlots().size(), is(1));
    p.removeAvailableSlot(new Slot(new GregorianCalendar(2018, 11, 27, 8, 00),
        new GregorianCalendar(2018, 11, 27, 9, 00), 5.5));
    azzert.that(p.getAvailableSlots().size(), is(0));
  }
  ...
  @Test public void getSlot() {
    final Parking p = new Parking(3, 1, size.PRIVATE_CAR, "Israel, Holon, Hahartsit, 8");
    azzert.that(p.getSlot(new GregorianCalendar(2018, 11, 27, 12, 00),
        new GregorianCalendar(2018, 11, 27, 14, 00)).getPrice_for_hour(), is((double) -1));
    ...
    azzert.that(p.getSlot(new Slot(new GregorianCalendar(2018, 11, 27, 12, 00),
        new GregorianCalendar(2018, 11, 27, 14, 00), 5.5)),
        is(new Slot(new GregorianCalendar(2018, 11, 27, 8, 00), new GregorianCalendar(2018, 11, 27, 20, 00), 5.5)));
    azzert.that(p.getAvailableSlots().size(), is(1));
    azzert.that(p.OrderSlot(new GregorianCalendar(2018, 11, 28, 12, 00),
        new GregorianCalendar(2018, 11, 28, 14, 00)).getPrice_for_hour(), is((double) -1));
    azzert.that(p.OrderSlot(new GregorianCalendar(2018, 11, 27, 8, 00),
        new GregorianCalendar(2018, 11, 27, 21, 00)).getPrice_for_hour(), is((double) -1));
    ...
    azzert.that(p.OrderSlot(new Slot(new GregorianCalendar(2018, 11, 27, 9, 00),
    ...
    azzert.that(p.OrderSlot(new Slot(new GregorianCalendar(2018, 11, 27, 8, 00),
